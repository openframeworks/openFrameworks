...
bool aprox_eq(const glm::vec3 & v1, const glm::vec3 & v2) {
	bool eq = fabs(v1.x - v2.x) < 0.001 && fabs(v1.y - v2.y) < 0.001 && fabs(v1.z - v2.z) < 0.001;
	if (!eq) {
...
bool aprox_eq(const glm::vec4 & v1, const glm::vec4 & v2) {
	bool eq = fabs(v1.x - v2.x) < 0.001 && fabs(v1.y - v2.y) < 0.001 && fabs(v1.z - v2.z) < 0.001 && fabs(v1.w - v2.w) < 0.001;
	if (!eq) {
		ofLogError() << "value1: " << v1;
		ofLogError() << "value2: " << v2;
	}
