...
To grab a copy of openFrameworks for your platform, visit the [download page](http://openframeworks.cc/download) on the main site.  
...
For more info on working with the Project Generator, for per-platform readmes, and additional information, see the [documentation](docs/table_of_contents.md).
