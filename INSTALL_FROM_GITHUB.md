...
* Or, easier, download a compiled Project Generator from the [nightly builds download page](https://github.com/openframeworks/projectGenerator/releases/tag/nightly), and copy the `projectGenerator` folder into your openFrameworks installation.
