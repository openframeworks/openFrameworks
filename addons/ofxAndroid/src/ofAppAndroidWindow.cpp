...
void Java_cc_openframeworks_OFAndroid_setAppDataDir(JNIEnv * env, jobject thiz, jstring data_dir) {
	jboolean iscopy;
...
void Java_cc_openframeworks_OFAndroid_onRestart(JNIEnv * env, jobject thiz) {
}

void Java_cc_openframeworks_OFAndroid_onStart(JNIEnv * env, jobject thiz) {
	ofLogVerbose("ofAppAndroidWindow") << "onStart";
	stopped = false;
	ofNotifyEvent(ofxAndroidEvents().start);
}

void Java_cc_openframeworks_OFAndroid_onStop(JNIEnv * env, jobject thiz) {
	ofLogVerbose("ofAppAndroidWindow") << "onStop";
	ofNotifyEvent(ofxAndroidEvents().stop);
	stopped = true;
}

void Java_cc_openframeworks_OFAndroid_onResume(JNIEnv * env, jobject thiz) {
	ofLogVerbose("ofAppAndroidWindow") << "onResume";
	ofNotifyEvent(ofxAndroidEvents().resume);
}

void Java_cc_openframeworks_OFAndroid_onPause(JNIEnv * env, jobject thiz) {
	ofLogVerbose("ofAppAndroidWindow") << "onPause";
	ofNotifyEvent(ofxAndroidEvents().pause);
}

void Java_cc_openframeworks_OFAndroid_onDestroy(JNIEnv * env, jclass thiz) {
	appSetup = false;
	ofEvents().notifyExit();
	ofExitCallback();
}

void Java_cc_openframeworks_OFAndroid_onSurfaceDestroyed(JNIEnv * env, jclass thiz) {
...
void Java_cc_openframeworks_OFAndroid_setup(JNIEnv * env, jclass thiz, jint w, jint h) {
...
void Java_cc_openframeworks_OFAndroid_resize(JNIEnv * env, jclass thiz, jint w, jint h) {
	sWindowWidth = w;
	sWindowHeight = h;
...
void Java_cc_openframeworks_OFAndroid_exit(JNIEnv * env, jclass thiz) {
	exit(0);
...
void Java_cc_openframeworks_OFAndroid_onTouchDown(JNIEnv * env, jclass thiz, jint id, jfloat x, jfloat y, jfloat pressure, jfloat majoraxis, jfloat minoraxis, jfloat angle) {
...
void Java_cc_openframeworks_OFAndroid_onTouchUp(JNIEnv * env, jclass thiz, jint id, jfloat x, jfloat y, jfloat pressure, jfloat majoraxis, jfloat minoraxis, jfloat angle) {
	ofTouchEventArgs touch;
	touch.id = id;
	touch.x = x;
	touch.y = y;
...
void Java_cc_openframeworks_OFAndroid_onTouchCancelled(JNIEnv * env, jclass thiz, jint id, jfloat x, jfloat y) {
	ofTouchEventArgs touch;
	touch.id = id;
	touch.x = x;
	touch.y = y;
...
void Java_cc_openframeworks_OFAndroid_onTouchMoved(JNIEnv * env, jclass thiz, jint id, jfloat x, jfloat y, jfloat pressure, jfloat majoraxis, jfloat minoraxis, jfloat angle) {
	ofTouchEventArgs touch;
	touch.id = id;
	touch.x = x;
	touch.y = y;
...
void Java_cc_openframeworks_OFAndroid_onTouchDoubleTap(JNIEnv * env, jclass thiz, jint id, jfloat x, jfloat y, jfloat pressure) {
	ofTouchEventArgs touch;
	touch.id = id;
	touch.x = x;
	touch.y = y;
...
void Java_cc_openframeworks_OFAndroid_onSwipe(JNIEnv * env, jclass thiz, jint id, jint swipeDir) {
...
void Java_cc_openframeworks_OFAndroid_onScaleEnd(JNIEnv * env, jclass thiz, jobject detector) {
	ofxAndroidScaleEventArgs scale(detector);
...
void Java_cc_openframeworks_OFAndroid_cancelPressed(JNIEnv * env, jobject thiz) {
	ofNotifyEvent(ofxAndroidEvents().cancelPressed);
}

void Java_cc_openframeworks_OFAndroid_networkConnected(JNIEnv * env, jobject thiz, jboolean connected) {
	bool bConnected = (bool)connected;
	ofNotifyEvent(ofxAndroidEvents().networkConnected, bConnected);
}

void Java_cc_openframeworks_OFAndroid_deviceOrientationChanged(JNIEnv * env, jclass thiz, jint orientation) {
