...
##########################################################################################
# define the openframeworks root if it has not been defined in a higher level file
ifndef OF_ROOT
    OF_ROOT=../../..
endif
...
ifndef OF_LIBS_OF_PATH
    OF_LIBS_OF_PATH=$(OF_LIBS_PATH)/openFrameworks
endif
ifndef OF_LIBS_OF_COMPILED_PATH
    OF_LIBS_OF_COMPILED_PATH=$(OF_LIBS_OF_PATH)Compiled
endif
...
ifndef OF_SHARED_MAKEFILES_PATH
    OF_SHARED_MAKEFILES_PATH=$(OF_LIBS_OF_COMPILED_PROJECT_PATH)/shared_makefiles
endif
...
ifdef MAKEFILE_DEBUG
    ...
    $(info OF_LIBS_OF_PATH=$(OF_LIBS_OF_PATH))
