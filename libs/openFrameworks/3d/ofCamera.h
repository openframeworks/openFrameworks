...
class ofCamera:public ofNode
{
  public:
    ...
    void setupPerspective (bool vFlip = true, float fov = 60, float nearDist =
                           0, float farDist = 0, const ofVec2f & lensOffset =
                           ofVec2f (0.0f, 0.0f));

    void setupOffAxisViewPortal (const ofVec3f & topLeft,
    ...
    ofMatrix4x4 getProjectionMatrix (ofRectangle viewport =
                                     ofRectangle ())const;
    ...
    ofMatrix4x4 getModelViewProjectionMatrix (ofRectangle viewport =
                                              ofRectangle ())const;
    ...
    ofVec3f worldToScreen (ofVec3f WorldXYZ, ofRectangle viewport =
                           ofRectangle ())const;
    ...
    ofVec3f screenToWorld (ofVec3f ScreenXYZ, ofRectangle viewport =
                           ofRectangle ())const;

    /// \todo worldToCamera()
    ofVec3f worldToCamera (ofVec3f WorldXYZ, ofRectangle viewport =
                           ofRectangle ())const;

    /// \todo cameraToWorld()
    ofVec3f cameraToWorld (ofVec3f CameraXYZ, ofRectangle viewport =
                           ofRectangle ())const;
