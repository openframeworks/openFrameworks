...
class ofMesh
{
  public:
    ...
    void setFromTriangles (const vector < ofMeshFace > &tris,
    ...
    /// \{
    static ofMesh plane (float width, float height, int columns =
                         2, int rows = 2, ofPrimitiveMode mode =
                         OF_PRIMITIVE_TRIANGLE_STRIP);
    static ofMesh sphere (float radius, int res = 12, ofPrimitiveMode mode =
                          OF_PRIMITIVE_TRIANGLE_STRIP);
    ...
    ///
    static ofMesh cylinder (float radius, float height, int radiusSegments =
                            12, int heightSegments = 6, int numCapSegments =
                            2, bool bCapped = true, ofPrimitiveMode mode =
                            OF_PRIMITIVE_TRIANGLE_STRIP);
    ...
    void addTriangle (ofIndexType index1, ofIndexType index2,
                      ofIndexType index3);
    ...
    void setColorForIndices (ofIndexType startIndex, ofIndexType endIndex,
                             ofColor color);
    ...
    ofMesh getMeshForIndices (ofIndexType startIndex,
                              ofIndexType endIndex) const;
    ofMesh getMeshForIndices (ofIndexType startIndex, ofIndexType endIndex,
