...
//			int monitorCount;
//			GLFWmonitor** monitors = glfwGetMonitors(&monitorCount);
			auto rect = getCurrentMonitorRect();
//			glfwSetWindowMonitor(windowP, monitors[getCurrentMonitorIndex()], 0, 0, rect.width, rect.height, GLFW_DONT_CARE);
