...
template < typename Window > void
ofSetupOpenGL (shared_ptr < Window > windowPtr, int w, int h,
...
template < typename Window > static void
noopDeleter (Window *)
{
}

template < typename Window > void
ofSetupOpenGL (Window * windowPtr, int w, int h, ofWindowMode screenMode)
{
    shared_ptr < Window > window =
        shared_ptr < Window > (windowPtr,
                               std::ptr_fun (noopDeleter < Window >));
...
void ofRunApp (shared_ptr < ofAppBaseWindow > window,
