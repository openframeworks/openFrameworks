...
/// \param z2 Z position of second point.
/// \returns distance-squared between two points.
float ofDistSquared (float x1, float y1, float z1, float x2, float y2,
                     float z2);
...
float ofWrapRadians (float angle, float from =
                     static_cast < float >(-PI), float to =
...
bool ofLineSegmentIntersection (const ofPoint & line1Start,
                                const ofPoint & line1End,
                                const ofPoint & line2Start,
                                const ofPoint & line2End,
...
ofPoint ofBezierPoint (const ofPoint & a, const ofPoint & b,
...
/// \param t an offset along the curve, normalized between 0 and 1.
/// \returns A ofPoint on the curve.
ofPoint ofCurvePoint (const ofPoint & a, const ofPoint & b, const ofPoint & c,
                      const ofPoint & d, float t);
...
/// \param t an offset along the curve, normalized between 0 and 1.
/// \returns A ofPoint on the curve.
ofPoint ofBezierTangent (const ofPoint & a, const ofPoint & b,
                         const ofPoint & c, const ofPoint & d, float t);
...
/// \param t an offset along the curve, normalized between 0 and 1.
/// \returns A ofPoint on the curve.
ofPoint ofCurveTangent (const ofPoint & a, const ofPoint & b,
                        const ofPoint & c, const ofPoint & d, float t);

template < typename Type >
    Type ofInterpolateCosine (const Type & y1, const Type & y2, float pct);
template < typename Type >
    Type ofInterpolateCubic (const Type & y0, const Type & y1,
                             const Type & y2, const Type & y3, float pct);
template < typename Type > Type ofInterpolateCatmullRom (const Type & y0,
                                                         const Type & y1,
                                                         const Type & y2,
                                                         const Type & y3,
                                                         float pct);
template < typename Type > Type ofInterpolateHermite (const Type & y0,
                                                      const Type & y1,
                                                      const Type & y2,
                                                      const Type & y3,
                                                      float pct);
...
//--------------------------------------------------
template < typename Type >
    Type ofInterpolateCatmullRom (const Type & y0, const Type & y1,
                                  const Type & y2, const Type & y3, float pct)
{
    Type a0, a1, a2, a3;
    float pct2 = pct * pct;
...
//--------------------------------------------------
template < typename Type >
    inline Type ofInterpolateHermite (const Type & y0, const Type & y1,
                                      const Type & y2, const Type & y3,
                                      float pct)
{
...
//--------------------------------------------------
template < typename Type >
    Type ofInterpolateHermite (const Type & y0, const Type & y1,
                               const Type & y2, const Type & y3, float pct,
