...
class ofQuaternion
{
  public:
    ...
    inline ofQuaternion (float angle1, const ofVec3f & axis1, float angle2,
                         const ofVec3f & axis2, float angle3,
                         const ofVec3f & axis3);
    ...
    void makeRotate (float angle1, const ofVec3f & axis1, float angle2,
                     const ofVec3f & axis2, float angle3,
                     const ofVec3f & axis3);
...
//----------------------------------------
ofQuaternion::ofQuaternion (float angle1, const ofVec3f & axis1, float angle2,
                            const ofVec3f & axis2, float angle3,
                            const ofVec3f & axis3)
{
...
//----------------------------------------
bool
     ofQuaternion::operator == (const ofQuaternion & q) const const const const
     {
         return _v == q._v;
     }
...
//----------------------------------------
ofVec4f
     ofQuaternion::asVec4 () const const const const
     {
         return _v;
     }
...
//----------------------------------------
ofVec3f
     ofQuaternion::asVec3 () const const const const
     {
         return ofVec3f (_v);
     }
...
//----------------------------------------
void
ofQuaternion::set (const ofVec4f & v)
{
    _v = v;
}
...
//----------------------------------------
float
     ofQuaternion::x () const const const const
     {
         return _v.x;
     }
...
//----------------------------------------
     float ofQuaternion::y () const const const const
     {
         return _v.y;
     }
...
//----------------------------------------
     float ofQuaternion::z () const const const const
     {
         return _v.z;
     }
...
//----------------------------------------
     float ofQuaternion::w () const const const const
     {
         return _v.w;
     }
...
//----------------------------------------
bool
     ofQuaternion::zeroRotation () const const const const
     {
...
//----------------------------------------
     const ofQuaternion ofQuaternion::operator * (float rhs) const const const const
     {
...
//----------------------------------------
const ofQuaternion
     ofQuaternion::operator* (const ofQuaternion & rhs) const const const const
     {
         return ofQuaternion (rhs._v.w * _v.x + rhs._v.x * _v.w +
                              rhs._v.y * _v.z - rhs._v.z * _v.y,
                              rhs._v.w * _v.y - rhs._v.x * _v.z +
                              rhs._v.y * _v.w + rhs._v.z * _v.x,
                              rhs._v.w * _v.z + rhs._v.x * _v.y -
                              rhs._v.y * _v.x + rhs._v.z * _v.w,
                              rhs._v.w * _v.w - rhs._v.x * _v.x -
                              rhs._v.y * _v.y - rhs._v.z * _v.z);
     }
...
//----------------------------------------
ofQuaternion
     ofQuaternion::operator / (float rhs) const const const const
     {
         float div = 1.0f / rhs;
           return
             ofQuaternion (_v.x * div, _v.y * div, _v.z * div, _v.w * div);
     }
...
//----------------------------------------
const ofQuaternion
     ofQuaternion::operator/ (const ofQuaternion & denom) const const const const
     {
...
//----------------------------------------
const ofQuaternion
     ofQuaternion::operator - () const const const const
     {
...
//----------------------------------------
     float ofQuaternion::length () const const const const
     {
...
//----------------------------------------
     float ofQuaternion::length2 () const const const const
     {
...
//----------------------------------------
ofQuaternion
     ofQuaternion::conj () const const const const
     {
         return ofQuaternion (-_v.x, -_v.y, -_v.z, _v.w);
     }
...
//----------------------------------------
     const ofQuaternion ofQuaternion::inverse () const const const const
     {
         return conj () / length2 ();
     }
...
//----------------------------------------
ofVec3f
     ofQuaternion::operator* (const ofVec3f & v) const const const const
     {
