...
class ofLog
{
  ...
  protected:
    ...
    /// \param message The log message.
    void _log (ofLogLevel level, const string & module,
...
class ofBaseLoggerChannel
{
  public:
    ...
    /// \param module The target module.
    /// \param message The log message.
    virtual void log (ofLogLevel level, const string & module,
    ...
    /// \param format The printf-style format string.
    virtual void log (ofLogLevel level, const string & module,
                      const char *format, ...) OF_PRINTF_ATTR (4, 5) = 0;
...
class ofConsoleLoggerChannel:public ofBaseLoggerChannel
{
  public:
    ...
    void log (ofLogLevel level, const string & module,
              const string & message);
