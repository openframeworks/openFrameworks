...
public:
    ...
    static std::string getPathForDirectory(const fs::path& path);
    ...
    static std::string getAbsolutePath(const fs::path& path, bool bRelativeToData = true);
    ...
    static std::string getEnclosingDirectory(const fs::path& filePath, bool bRelativeToData = true);
...
public:
	...
	static bool doesFileExist(const fs::path& fPath,  bool bRelativeToData = true);
