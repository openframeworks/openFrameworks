...
class ofTrueTypeFont
{
  ...
  public:
    ...
    /// \todo Documentation.
    ofTTFCharacter getCharacterAsPoints (int character, bool vflip =
                                         true, bool filled = true) const;
      vector < ofTTFCharacter > getStringAsPoints (const std::string & str,
                                                   bool vflip =
                                                   true, bool filled =
                                                   true) const;
    const ofMesh & getStringMesh (const std::string & s, float x, float y,
                                  bool vflip = true) const;
  ...
  protected:
    ...
    void drawCharAsShape (int c, float x, float y, bool vFlipped,
                          bool filled) const;
    void createStringMesh (const std::string & s, float x, float y,
                           bool vFlipped) const;
