...
public:
    ...
    ///
    /// You need to call reloadTexture() to update the texture after updating
    /// the pixels manually.    
    ///
    ...
    /// \brief Loads ofPixels data into ofTexture so that draw() calls reflect
    /// changes to the pixels.
    /// 
    /// This is a more lightweight version of update() that just will take the
    /// pixel data and load it in the texture    
    void reloadTexture();
