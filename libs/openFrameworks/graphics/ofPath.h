...
class ofPath
{
  public:
    ...
    void quadBezierTo (const ofPoint & cp1, const ofPoint & cp2,
                       const ofPoint & p);
    ...
    /// while 180,0 is not.
    void arc (const ofPoint & centre, float radiusX, float radiusY,
    ...
    void arcNegative (const ofPoint & centre, float radiusX, float radiusY,
                      float angleBegin, float angleEnd);
    ...
    void triangle (const ofPoint & p1, const ofPoint & p2,
                   const ofPoint & p3);
    ...
    void rectRounded (const ofPoint & p, float w, float h,
    ...
    void rectRounded (float x, float y, float z, float w, float h,
                      float topLeftRadius, float topRightRadius,
                      float bottomRightRadius, float bottomLeftRadius);
    /// \}
    /// \name Winding Mode
    ...
    int getCircleResolution () const;
      ...
      OF_DEPRECATED_MSG ("Use setCircleResolution instead.",
                         void setArcResolution (int res));
      OF_DEPRECATED_MSG ("Use getCircleResolution instead.",
    ...
    struct Command
    {
        ...
        /// for bezierTo
          Command (Type type, const ofPoint & p, const ofPoint & cp1,
                   const ofPoint & cp2);

        ///for arc
          Command (Type type, const ofPoint & centre, float radiusX,
                   float radiusY, float angleBegin, float angleEnd);
