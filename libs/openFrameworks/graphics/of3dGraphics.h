...
// Deprecated Methods //
OF_DEPRECATED_MSG ("Use ofDrawSphere instead.",
...
// Cylinder //
void ofSetCylinderResolution (int radiusSegments, int heightSegments,
                              int capSegments = 2);
...
void ofSetConeResolution (int radiusSegments, int heightSegments,
                          int capSegments = 2);
...
// Deprecated Methods //
OF_DEPRECATED_MSG ("Use ofDrawCone instead.",
                   void ofCone (float x, float y, float z, float radius,
                                float height));
OF_DEPRECATED_MSG ("Use ofDrawCone instead.",
                   void ofCone (float x, float y, float radius,
                                float height));
OF_DEPRECATED_MSG ("Use ofDrawCone instead.",
                   void ofCone (const ofPoint & position, float radius,
                                float height));
OF_DEPRECATED_MSG ("Use ofDrawCone instead.",
...
void ofDrawBox (float x, float y, float z, float width, float height,
                float depth);
...
/// \param height The height of the box.
/// \param depth The depth of the box.
void ofDrawBox (const ofPoint & position, float width, float height,
                float depth);
...
OF_DEPRECATED_MSG ("Use ofDrawBox instead.",
                   void ofBox (float x, float y, float z, float width,
                               float height, float depth));
OF_DEPRECATED_MSG ("Use ofDrawBox instead.",
                   void ofBox (float x, float y, float z, float size));
OF_DEPRECATED_MSG ("Use ofDrawBox instead.",
                   void ofBox (const ofPoint & position, float width,
                               float height, float depth));
OF_DEPRECATED_MSG ("Use ofDrawBox instead.",
...
class of3dGraphics
{
  public:
    ...
    void drawPlane (float x, float y, float z, float width,
                    float height) const;
    ...
    // Cylinder //
    void setCylinderResolution (int radiusSegments, int heightSegments,
                                int capSegments = 2);
    ...
    void drawCylinder (float x, float y, float z, float radius,
                       float height) const;
    void drawCylinder (const ofPoint & position, float radius,
                       float height) const;
    ...
    /// \param heightSegments The number of subdivisions from the cone's top to bottom.
    /// \param capSegments The number of annular (ring-shaped) subdivisions of the cone's endcap.
    void setConeResolution (int radiusSegments, int heightSegments,
                            int capSegments = 2);
    ...
    void drawCone (const ofPoint & position, float radius,
                   float height) const;
    ...
    /// \param height The height of the box.
    /// \param depth The depth of the box.
    void drawBox (float x, float y, float z, float width, float height,
                  float depth) const;
    ...
    /// \param height The height of the box.
    /// \param depth The depth of the box.
    void drawBox (const ofPoint & position, float width, float height,
                  float depth) const;
    ...
    void drawGrid (float stepSize, size_t numberOfSteps, bool labels, bool x,
                   bool y, bool z) const;
    void drawGridPlane (float stepSize, size_t numberOfSteps,
                        bool labels) const;
    void drawArrow (const ofVec3f & start, const ofVec3f & end,
                    float headSize) const;
    void drawRotationAxes (float radius, float stripWidth,
                           int circleRes) const;
