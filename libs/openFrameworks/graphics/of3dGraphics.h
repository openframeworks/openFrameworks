...
/// \section Planes
/// \brief Set the resolution the current renderer will use when drawing planes.
...
/// \brief Draw a plane with the current renderer at the coordinate system's
/// origin.
/// \param width The width of the plane.
/// \param height The height of the plane.
...
/// \section Spheres
/// \brief Set the resolution the current renderer will use when drawing
/// spheres.
///
...
/// \brief Draw an icosphere with the current renderer at the coordinate
/// system's origin.
///
/// Icospheres are drawn with their position coordinates representing the center
...
/// \brief Draw a cylinder with the current renderer using x, y, radius, and
/// height.
///
...
/// \brief Draw a cylinder with the current renderer using x, y, z, radius, and
/// height.
///
...
/// \brief Draw a cylinder with the current renderer using position, radius, and
/// height.
///
/// Cyliners are drawn with x, y, and z coordinates representing the
/// centroid of the cylinder.
...
/// \section Cones
/// \brief Set the resolution the current renderer will use when drawing cones.
///
...
/// \brief Retrieve a data structure describing the resolution with which cones
/// are polygonized.
///
...
/// \brief Draw a cone with the current renderer using x, y, z, radius, and
/// height.
///
/// Cones are drawn with x, y, and z coordinates representing the centroid
/// of the cone.
...
/// The box is drawn filled by default; change this with ofFill();
///
/// \param position an ofPoint which contains the (x,y,z) coordinates for the
...
public:
	...
	///
	/// Spheres are drawn with their position representing the center of the
	/// sphere. This function draws a sphere at the coordinate system origin of
	/// 0, 0, 0.
	///
	/// \param radius The radius of the sphere.
	...
	/// \param res The number of subdivisions to use for box widths, heights,
	/// and depths.
	...
	/// respectively.
	///
	/// \returns The current box resolution as a 3D vector.
	...
	/// It is also known as a regular hexahedron, a square parallelepiped, an
	/// equilateral cuboid
	/// and a right rhombohedron. It is a regular square prism in three
	/// orientations.
	///
	/// It is drawn starting from a 3D reference coordinate, with the specified
	/// size.
	...
	/// \brief Draws a cube at the origin.
	///
	/// The cube is drawn with the current color, e.g. set with ofSetColor().
	/// The cube is drawn filled by default; change this with ofFill();
	///
	...
	/// \brief Draw a cube at the origin.
	///
	/// A box is a rectangular solid: an extruded rectangle.
	/// It is drawn starting from the origin of the current reference frame.
	/// It has a width (in x), a height (in y), and a depth (in z).
