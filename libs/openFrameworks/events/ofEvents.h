...
enum ofKey{
	...
	// Use values from the unused Unicode codepoint range 0870 - 089F. 
	// See https://unicode-table.com/en/#syriac-supplement
	OF_KEY_F1        = 0x870,
	OF_KEY_F2        = 0x871,
	OF_KEY_F3        = 0x872,
	OF_KEY_F4        = 0x873,
	...
	OF_KEY_RIGHT     = 0x87E,
	OF_KEY_DOWN      = 0x87F,
	OF_KEY_PAGE_UP   = 0x880,
	OF_KEY_PAGE_DOWN = 0x881,
	OF_KEY_HOME      = 0x882,
	OF_KEY_END       = 0x883,
	OF_KEY_INSERT    = 0x884,
