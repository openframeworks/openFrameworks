...
# )
PACMAN_PACKAGES=(
make pkg-config gcc openal glew freeglut freeimage freetype2 cairo gstreamer gst-plugins-base gst-plugins-good gst-plugins-bad gst-libav assimp boost libxcursor opencv assimp glfw-x11  uriparser curl pugixml
)
