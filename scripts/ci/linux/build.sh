...
cd $ROOT
cp scripts/linux/template/standard/linux64/Makefile examples/empty/emptyExample/
cp scripts/linux/template/standard/linux64/config.make examples/empty/emptyExample/
cd examples/empty/emptyExample
make Debug

echo "**** Building allAddonsExample ****"
cd $ROOT
cp scripts/linux/template/standard/linux64/Makefile examples/addons/allAddonsExample/
cp scripts/linux/template/standard/linux64/config.make examples/addons/allAddonsExample/
