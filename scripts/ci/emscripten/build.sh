...
sed -i "s/PLATFORM_OPTIMIZATION_CFLAGS_DEBUG = .*/PLATFORM_OPTIMIZATION_CFLAGS_DEBUG = -g0 -c -r/" libs/openFrameworksCompiled/project/emscripten/config.emscripten.default.mk
