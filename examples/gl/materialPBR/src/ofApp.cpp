...
void ofApp::draw() {
	...
	if (!ofIsGLProgrammableRenderer()) {
		ss << endl
		   << "PBR only works with programmable renderer.";
	}
	ss << endl
	   << "Row 1: 0 -> 1 metallic of smooth surface";
	ss << endl
	   << "Row 2: 0 -> 1 roughness of metallic surface.";
	ss << endl
	   << "Row 3: 0 -> 1 reflectivity of non-metal surface.";
