...
void ofApp::setup() {
    ...
    avVideoPlayer = video.getAVFoundationVideoPlayer();
...
void ofApp::nativeOnPressed() {
    [video.getAVFoundationVideoPlayer() playerView].hidden = NO;
    [controls setNative:YES];
}

void ofApp::nativeOffPressed() {
    [video.getAVFoundationVideoPlayer() playerView].hidden = YES;
