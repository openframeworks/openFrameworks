...
PLATFORM_CORE_EXCLUSIONS += $(OF_ROOT)/src/video/ofQtUtils.cpp
PLATFORM_CORE_EXCLUSIONS += $(OF_ROOT)/src/video/ofQuickTimeGrabber.cpp
PLATFORM_CORE_EXCLUSIONS += $(OF_ROOT)/src/video/ofQuickTimePlayer.cpp
PLATFORM_CORE_EXCLUSIONS += $(OF_ROOT)/src/video/ofDirectShowGrabber.cpp
PLATFORM_CORE_EXCLUSIONS += $(OF_ROOT)/src/video/ofDirectShowPlayer.cpp

ifeq ($(LINUX_ARM),1)
	PLATFORM_CORE_EXCLUSIONS += $(OF_ROOT)/src/app/ofAppGlutWindow.cpp
else
	PLATFORM_CORE_EXCLUSIONS += $(OF_ROOT)/src/app/ofAppEGLWindow.cpp
endif
...
ifeq ($(USE_FMOD),0)
	...
	PLATFORM_CORE_EXCLUSIONS += $(OF_ROOT)/src/sound/ofFmodSoundPlayer.cpp
endif
