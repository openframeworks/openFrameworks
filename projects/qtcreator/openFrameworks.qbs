...
Product{
    ...
    readonly property string projectDir: of.ofRoot + "/projects"
    readonly property string libDir: of.ofRoot + "/build/" + of.platform
    ...
    Transformer {
        ...
        prepare: {           
            var qbsCmd = new Command(product.make, ['Debug', 'USE_FMOD=0']);
    ...
    Transformer {
        ...
        prepare: {
            var qbsCmd = new Command(product.make, ['Release', 'USE_FMOD=0']);
            qbsCmd.description = "building openFrameworks library";
            qbsCmd.workingDirectory = product.projectDir;
            qbsCmd.silent = false;
            qbsCmd.highlight = 'compiler';
