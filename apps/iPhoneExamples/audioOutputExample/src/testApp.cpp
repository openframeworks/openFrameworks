...
void testApp::setup(){
	...
	//if your sound doesn't work in the simulator - read this post - which requires you set the output stream to 24bit 
...
void testApp::draw(){
	...
	for (int i = 0; i < initialBufferSize; i++){
		ofLine(70+i,200,70+i,200+lAudio[i]*100.0f);
	}

	// draw the right:
	ofSetColor(0x333333);
	ofRect(500,100,256,200);
	ofSetColor(0xFFFFFF);
	for (int i = 0; i < initialBufferSize; i++){
		ofLine(500+i,200,500+i,200+rAudio[i]*100.0f);
	}
