...
void ofApp::draw() {
	...
	ofDrawBitmapString("non floating point FBO: GL_RGB - without alpha \n"
					   ...
					   "red:"
			+ ofToString(int(c.r)) + " green:" + ofToString(int(c.g)) + " blue:" + ofToString(int(c.b)),
	...
	ofDrawBitmapString("non floating point FBO: GL_RGBA - with alpha \n"
			...
			+ ofToString(int(c.r)) + " green:" + ofToString(int(c.g)) + " blue:" + ofToString(int(c.b)) + "\n"
																										  ...
																										  "red:"
			+ ofToString(int(fboColor.r)) + " green:" + ofToString(int(fboColor.g)) + " blue:" + ofToString(int(fboColor.b)) + " alpha:" + ofToString(int(fboColor.a)),
		ofPoint(420, 230)); // subtitle
	...
	ofDrawBitmapString("floating point FBO: RGB32F_ARB - without alpha \n"
					   ...
					   "color of the screen on the top left of the fbo: \n"
					   "red:"
			+ ofToString(float(c.r)) + " green:" + ofToString(float(c.g)) + " blue:" + ofToString(float(c.b)),
		ofPoint(10, 550));
	...
	ofDrawBitmapString("floating point FBO: GL_RGBA32F_ARB - with alpha \n"
			...
			+ ofToString(float(c.r)) + " green:" + ofToString(float(c.g)) + " blue:" + ofToString(float(c.b)) + "\n"
																												...
																												"color of the fbo on the top left of the fbo: \n"
																												"red:"
			+ ofToString(float(fboFloatColor.r)) + " green:" + ofToString(float(fboFloatColor.g)) + " blue:"
			+ ofToString(float(fboFloatColor.b), 6) + " alpha:" + ofToString(float(fboFloatColor.a), 6),
		ofPoint(420, 550));
}
